...
(assert (not (and B113-F (or B20-F B25-F B30-F B39-F B44-F B49-F B58-F B63-F B68-F B78-F B83-F B88-F B96-F B101-F B106-F B110-F) (distinct I113 (+ I20 (- 999999999999) I30 I39 I44 I49 I58 I63 I68 I78 I83 I88 I96 I101 I106 I110)))))
...
(assert (not (and (or B20-F B25-F B30-F) (or (> (* I20 100) (+ (* I19 15) 100)) (> (- 99999999999900) (+ (* I24 15) 100)) (> (* I30 100) (+ (* I29 15) 100))))))
(assert (not (and B25-F B26-F (> (ite (>= (- I26 (- 5499999999995)) 0) (- I26 (- 5499999999995)) (- (- I26 (- 5499999999995)))) 100))))
...
(assert (not (and B110-F (> (* I110 100) (- 14999999999885)))))
