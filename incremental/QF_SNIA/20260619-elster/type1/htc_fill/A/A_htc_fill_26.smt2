...
number variables: 256, number constraints: 240
...
(assert (= B138-F (or B139-F B140-F B141-F B142-F)))
...
(assert (and (<= I132 99999999999999) (>= I132 (- 9999999999999))))
...
(assert (not (and (or B135-F B134-F) (not (and B135-F B134-F)))))
...
(assert (not (and B137-F (not (and B139-F B140-F)))))
(assert (not (and (not B137-F) (or B139-F B140-F))))
(assert (not (and B5-F (= S4-S "0"))))
(assert (not (and B5-F (= S5-S S3-S))))
(assert B2-F)
(assert (not (distinct I132 (+ I120 I116 I117 I121 I122 I124 I125 I131 I128 I129 I126 I127 I130 199987307431605))))
(assert (not (and B113-F (distinct I132 (* I113 100)))))
