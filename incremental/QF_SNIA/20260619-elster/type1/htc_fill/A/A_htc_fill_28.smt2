...
number variables: 261, number constraints: 251
...
(assert (not (and B113-F (or B20-F B25-F B30-F B39-F B44-F B49-F B58-F B63-F B68-F B78-F B83-F B88-F B96-F B101-F B106-F B110-F) (distinct (- 9732134) (+ I20 I25 I30 I39 I44 I49 I63 I68 I78 I83 I96 I101 I106 (- 995439646319))))))
...
(assert (not (and (or B19-F B24-F B29-F) (or (= I20 0) (and (distinct I24 0) (= I25 0)) (and (distinct I29 0) (= I30 0))))))
...
(assert (not (and (or B20-F B25-F B30-F) (or (> (* I20 100) 85) (> (* I25 100) (+ (* I24 15) 100)) (> (* I30 100) (+ (* I29 15) 100))))))
...
(assert (not (and (or B78-F B83-F B88-F) (or (> (* I78 100) (+ (* I77 15) 100)) (> (* I83 100) (+ (* I82 15) 100)) (> (- 100) (+ (* I87 15) 100))))))
...
(assert (not (and B88-F B89-F (> (ite (>= (- I89 (- 6)) 0) (- I89 (- 6)) (- (- I89 (- 6)))) 100))))
...
(assert (not (and (or B95-F B100-F B105-F) (or (= I96 0) (and (distinct I100 0) (= I101 0)) (and (distinct I105 0) (= I106 0))))))
...
(assert (not (and (or B96-F B101-F B106-F) (or (> (* I96 100) 115) (> (* I101 100) (+ (* I100 15) 100)) (> (* I106 100) (+ (* I105 15) 100))))))
...
(assert (not (and B110-F B111-F (> (ite (>= (- I111 25081945245) 0) (- I111 25081945245) (- (- I111 25081945245))) 100))))
(assert (not (and B110-F (> 456035368100 (+ (* I109 15) 100)))))
...
(assert (not (and (or B57-F B62-F B67-F) (or (and (distinct I62 0) (= I63 0)) (and (distinct I67 0) (= I68 0))))))
(assert (not (and B58-F B59-F (> (ite (>= (- I59 (- 5499999999995)) 0) (- I59 (- 5499999999995)) (- (- I59 (- 5499999999995)))) 100))))
(assert (not (and (or B56-F B57-F B58-F B59-F) (not (and B56-F B57-F B58-F B59-F)))))
(assert (not (and (or B58-F B63-F B68-F) (or (> (* I63 100) (+ (* I62 15) 100)) (> (* I68 100) (+ (* I67 15) 100))))))
...
(assert (not (and B139-F (or B125-F B124-F B126-F B122-F B123-F B127-F B128-F B129-F B130-F B131-F B138-F B132-F B135-F B136-F B133-F B134-F B137-F) (distinct I140 (+ I125 I124 I126 I122 I123 I127 I128 I130 I131 I138 I135 I136 I133 I134 I137 99999999999998)))))
...
(assert (not (and B139-F B113-F (distinct I140 (- 973213400)))))
