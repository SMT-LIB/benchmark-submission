...
(pop 1)
(push 1)
(assert (and (or (not B1-F) (not B10-F) (not B11-F)) (or (< 2026 (ite B10-F I10-y 0)) (and (= 2026 (ite B10-F I10-y 0)) (<= 6 (str.to_int (ite B11-F S11-S "")))))))
(set-info :status unsat)
(check-sat)
(pop 1)
(push 1)
(assert (and B1-F B10-F B11-F (>= 2026 I10-y) (distinct 2026 I10-y) (<= 6 (str.to_int S11-S))))
(set-info :status sat)
(check-sat)
(pop 1)
(push 1)
(assert (and B1-F B10-F B11-F (>= 2026 I10-y) (= 2026 I10-y) (> 6 (str.to_int S11-S))))
(set-info :status unsat)
(check-sat)
(pop 1)
(push 1)
(assert (and B11-F (= S11-S "12")))
(set-info :status sat)
(check-sat)
(pop 1)
(push 1)
