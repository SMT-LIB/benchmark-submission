...
(pop 1)
(push 1)
(assert (and B15-F (= I15-y (ite B10-F I10-y 0)) (= I15-m (str.to_int (ite B11-F S11-S "")))))
(set-info :status sat)
(check-sat)
(pop 1)
(push 1)
(assert (and (not B15-F) (< 0 (str.to_int (str.substr (ite B14-F S14-S "") 0 4)))))
(set-info :status unsat)
(check-sat)
(pop 1)
(push 1)
(assert (and B15-F (>= I15-y (str.to_int (str.substr (ite B14-F S14-S "") 0 4)))))
(set-info :status sat)
(check-sat)
(pop 1)
(push 1)
(assert (and (= I15-y 2026) (= I15-m 6) (= I15-d 21)))
(set-info :status unsat)
(check-sat)
(pop 1)
(push 1)
...
(pop 1)
(push 1)
(assert (and (not B38-F) (not B43-F) (not B48-F) (or (and (distinct I38 0) (= I39 0)) (and (distinct I43 0) (= I44 0)) (and (distinct I48 0) (= I49 0)))))
(set-info :status unsat)
(check-sat)
(pop 1)
(push 1)
...
(pop 1)
(push 1)
(assert (and (or (not B78-F) (not B79-F)) (> (ite (>= (- I79 (div (* I78 55) 10)) 0) (- I79 (div (* I78 55) 10)) (- (- I79 (div (* I78 55) 10)))) 100)))
(set-info :status unsat)
(check-sat)
(pop 1)
(push 1)
