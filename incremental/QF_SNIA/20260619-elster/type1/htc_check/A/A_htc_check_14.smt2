...
(pop 1)
(push 1)
(assert (and B34-F (= I34-y (ite B10-F I10-y 0)) (= I34-m (str.to_int (ite B11-F S11-S "")))))
(set-info :status sat)
(check-sat)
(pop 1)
(push 1)
...
(pop 1)
(push 1)
(assert (and B33-F B34-F))
(set-info :status sat)
(check-sat)
(pop 1)
(push 1)
(assert (and (= I34-y 2026) (= I34-m 6) (= I34-d 21)))
(set-info :status unsat)
(check-sat)
(pop 1)
(push 1)
...
(pop 1)
(push 1)
(assert (and B91-F (<= I91-y (ite B10-F I10-y 0)) (<= I91-m (str.to_int (ite B11-F S11-S ""))) (= I91-y (ite B10-F I10-y 0))))
(set-info :status sat)
(check-sat)
(pop 1)
(push 1)
(assert (and B91-F (<= I91-y (ite B10-F I10-y 0)) (> I91-m (str.to_int (ite B11-F S11-S ""))) (distinct I91-y (ite B10-F I10-y 0))))
(set-info :status sat)
(check-sat)
(pop 1)
(push 1)
(assert (and (= I91-y 2026) (= I91-m 6) (= I91-d 21)))
(set-info :status unsat)
(check-sat)
(pop 1)
(push 1)
