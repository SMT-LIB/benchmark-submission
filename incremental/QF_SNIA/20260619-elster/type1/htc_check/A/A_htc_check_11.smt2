...
(pop 1)
(push 1)
(assert (and B10-F (>= I10-y 2025) (<= I10-y 2025)))
(set-info :status sat)
(check-sat)
(pop 1)
(push 1)
...
(pop 1)
(push 1)
(assert (and (not B58-F) (not B63-F) (not B68-F) (or (> (* I58 100) (+ (* I57 15) 100)) (> (* I63 100) (+ (* I62 15) 100)) (> (* I68 100) (+ (* I67 15) 100)))))
(set-info :status unsat)
(check-sat)
(pop 1)
(push 1)
