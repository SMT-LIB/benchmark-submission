...
(pop 1)
(push 1)
(assert (and (not B16-F) B15-F (or (> I16-y I15-y) (and (= I16-y I15-y) (> I16-m I15-m)) (and (= I16-y I15-y) (= I16-m I15-m) (> I16-d I15-d)))))
(set-info :status unsat)
(check-sat)
(pop 1)
(push 1)
(assert (and B16-F (not B15-F) (or (> I16-y I15-y) (and (= I16-y I15-y) (> I16-m I15-m)) (and (= I16-y I15-y) (= I16-m I15-m) (> I16-d I15-d)))))
(set-info :status unsat)
(check-sat)
(pop 1)
(push 1)
...
(pop 1)
(push 1)
(assert (and (or (not B14-F) (not B16-F)) (>= (ite (and (>= (str.to_int S14-S) 1) (<= (str.to_int S14-S) 9999) B14-F B16-F) (+ (- I16-y (str.to_int S14-S)) (ite (or (< (str.to_int S14-S) I16-y) (and (= (str.to_int S14-S) I16-y) (< 5 I16-m)) (and (= (str.to_int S14-S) I16-y) (= 5 I16-m) (< 1 I16-d)) (and (= (str.to_int S14-S) I16-y) (= 5 I16-m) (= 1 I16-d))) (ite (or (< 5 I16-m) (and (= 5 I16-m) (<= 1 I16-d))) 0 (- 1)) (ite (or (> 5 I16-m) (and (= 5 I16-m) (>= 1 I16-d))) 0 1))) 0) 1)))
(set-info :status unsat)
(check-sat)
(pop 1)
(push 1)
(assert (and B14-F B16-F (< (ite (and (>= (str.to_int S14-S) 1) (<= (str.to_int S14-S) 9999)) (+ (- I16-y (str.to_int S14-S)) (ite (or (< (str.to_int S14-S) I16-y) (and (= (str.to_int S14-S) I16-y) (< 5 I16-m)) (and (= (str.to_int S14-S) I16-y) (= 5 I16-m) (< 1 I16-d)) (and (= (str.to_int S14-S) I16-y) (= 5 I16-m) (= 1 I16-d))) (ite (or (< 5 I16-m) (and (= 5 I16-m) (<= 1 I16-d))) 0 (- 1)) (ite (or (> 5 I16-m) (and (= 5 I16-m) (>= 1 I16-d))) 0 1))) 0) 1)))
(set-info :status sat)
(check-sat)
(pop 1)
(push 1)
...
(pop 1)
(push 1)
(assert (and (= I16-y 2026) (= I16-m 6) (= I16-d 21)))
(set-info :status unsat)
(check-sat)
(pop 1)
(push 1)
...
(pop 1)
(push 1)
(assert (and (not B96-F) (not B101-F) (not B106-F) (or (> (* I96 100) (+ (* I95 15) 100)) (> (* I101 100) (+ (* I100 15) 100)) (> (* I106 100) (+ (* I105 15) 100)))))
(set-info :status unsat)
(check-sat)
(pop 1)
(push 1)
