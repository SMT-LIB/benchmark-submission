...
(pop 1)
(push 1)
(assert (and (not B54-F) (not B53-F) (not B52-F) (not B55-F) (not B65-F)))
(set-info :status unsat)
(check-sat)
(pop 1)
(push 1)
...
(pop 1)
(push 1)
(assert (and (or B1-F B10-F B11-F) (not B13-F) (not B32-F) (not B70-F) (not B90-F)))
(set-info :status unsat)
(check-sat)
(pop 1)
(push 1)
...
(pop 1)
(push 1)
(assert (and (not B21-F) (not B26-F) (not B31-F) (not B40-F) (not B45-F) (not B50-F) (not B59-F) (not B64-F) (not B69-F) (not B79-F) (not B84-F) (not B89-F) (not B97-F) (not B102-F) (not B107-F) (not B111-F) (not B114-F)))
(set-info :status unsat)
(check-sat)
(pop 1)
(push 1)
...
(pop 1)
(push 1)
(assert (and (or (not B54-F) (not B53-F) (not B52-F)) (not B55-F) (not B65-F)))
(set-info :status unsat)
(check-sat)
(pop 1)
(push 1)
