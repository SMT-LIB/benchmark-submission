...
(pop 1)
(push 1)
(assert (and B33-F (>= I33-s-y (- I33-e-y 1)) (or (distinct I33-s-y (- I33-e-y 1)) (>= I33-s-m I33-e-m)) (distinct I33-s-y (- I33-e-y 1)) (= I33-s-m I33-e-m) (< I33-s-d (+ I33-e-d 1))))
(set-info :status sat)
(check-sat)
(push 1)
...
(pop 1)
(push 1)
(assert (and (not B72-F) (or (= 0 (ite B10-F I10-y 0)) (and (distinct 0 (ite B10-F I10-y 0)) (< 0 (- (ite B10-F I10-y 0) 1))) (and (distinct 0 (ite B10-F I10-y 0)) (= 0 (- (ite B10-F I10-y 0) 1))))))
(set-info :status unsat)
(check-sat)
(pop 1)
(push 1)
...
(pop 1)
(push 1)
(assert (and B5-F (= S5-S "2348008413417")))
(set-info :status sat)
(check-sat)
(push 1)
(assert B75-F)
...
(check-sat)
(push 1)
(assert (and (or B57-F B62-F B67-F) (distinct I68 0)))
(set-info :status sat)
(check-sat)
(push 1)
(assert B48-F)
