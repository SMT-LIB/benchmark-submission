...
(pop 1)
(push 1)
(assert (and B52-F (= I52-s-y 2024) (= I52-s-m 2) (= I52-s-d 29) (= I52-e-y 2025) (= I52-e-m 6) (= I52-e-d 18)))
(set-info :status unsat)
(check-sat)
(pop 1)
(push 1)
...
(pop 1)
(push 1)
(assert (and B52-F (= I52-s-y 2025) (= I52-s-m 6) (= I52-s-d 18) (= I52-e-y 2027) (= I52-e-m 12) (= I52-e-d 31)))
(set-info :status unsat)
(check-sat)
(pop 1)
(push 1)
...
(pop 1)
(push 1)
(assert (and (or (not B58-F) (not B59-F)) (> (ite (>= (- I59 (div (* I58 55) 10)) 0) (- I59 (div (* I58 55) 10)) (- (- I59 (div (* I58 55) 10)))) 100)))
(set-info :status unsat)
(check-sat)
(pop 1)
(push 1)
