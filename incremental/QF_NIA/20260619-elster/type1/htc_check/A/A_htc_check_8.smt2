...
(pop 1)
(push 1)
(assert (and B33-F (= I33-s-y 2024) (= I33-s-m 2) (= I33-s-d 29) (= I33-e-y 2025) (= I33-e-m 6) (= I33-e-d 18)))
(set-info :status unsat)
(check-sat)
(pop 1)
(push 1)
...
(pop 1)
(push 1)
(assert (and B33-F (= I33-s-y 2025) (= I33-s-m 6) (= I33-s-d 18) (= I33-e-y 2027) (= I33-e-m 12) (= I33-e-d 31)))
(set-info :status unsat)
(check-sat)
(pop 1)
(push 1)
...
(pop 1)
(push 1)
(assert (and (or (not B39-F) (not B40-F)) (> (ite (>= (- I40 (div (* I39 55) 10)) 0) (- I40 (div (* I39 55) 10)) (- (- I40 (div (* I39 55) 10)))) 100)))
(set-info :status unsat)
(check-sat)
(pop 1)
(push 1)
