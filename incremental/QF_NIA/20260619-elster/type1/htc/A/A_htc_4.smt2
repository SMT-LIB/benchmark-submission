...
(pop 1)
(push 1)
(assert (and (or B57-F B62-F B67-F) (= I57 0) (= I58 0)))
(set-info :status unsat)
(check-sat)
(pop 1)
(push 1)
...
(pop 1)
(push 1)
(assert (and (or B95-F B100-F B105-F) (or (= I95 0) (distinct I96 0)) (distinct I101 0) (= I105 0) (= I106 0)))
(set-info :status unsat)
(check-sat)
(pop 1)
(push 1)
