...
(pop 1)
(push 1)
(assert (and (or B1-F B10-F B11-F) B13-F (not B32-F) (not B51-F) (not B70-F)))
(set-info :status unsat)
(check-sat)
(pop 1)
(push 1)
(assert (and (or B1-F B10-F B11-F) (not B13-F) B32-F (not B51-F) (not B70-F)))
(set-info :status unsat)
(check-sat)
(pop 1)
(push 1)
(assert (and (or B1-F B10-F B11-F) (not B13-F) (not B32-F) B51-F (not B70-F)))
(set-info :status unsat)
(check-sat)
(pop 1)
(push 1)
(assert (and (or B1-F B10-F B11-F) (not B13-F) (not B32-F) (not B51-F) B70-F))
(set-info :status unsat)
(check-sat)
(pop 1)
(push 1)
