...
(check-sat)
(push 1)
(assert (and (or B19-F B24-F B29-F) (or (= I24 0) (distinct I25 0)) (distinct I30 0)))
(set-info :status sat)
(check-sat)
(push 1)
(assert B25-F)
...
(check-sat)
(push 1)
(assert (and (or (distinct I72-y (ite B10-F I10-y 0)) (>= I72-m (- I11-N 4))) (or (= I72-y (ite B10-F I10-y 0)) (>= I72-y (- (ite B10-F I10-y 0) 1))) (or (= I72-y (ite B10-F I10-y 0)) (distinct I72-y (- (ite B10-F I10-y 0) 1)) (<= I72-m 8) (>= I72-m (- (+ I11-N 12) 4))) (distinct I72-y (ite B10-F I10-y 0)) (= I72-y (- (ite B10-F I10-y 0) 1)) (> I72-m 8)))
(set-info :status sat)
(check-sat)
(push 1)
(assert (and (or (distinct I72-y (ite B10-F I10-y 0)) (>= I72-m (- I11-N 4))) (distinct I72-y (ite B10-F I10-y 0)) (>= I72-y (- (ite B10-F I10-y 0) 1)) (or (= I72-y (ite B10-F I10-y 0)) (distinct I72-y (- (ite B10-F I10-y 0) 1)) (<= I72-m 8) (>= I72-m (- (+ I11-N 12) 4))) (or (= I72-y (ite B10-F I10-y 0)) (distinct I72-y (- (ite B10-F I10-y 0) 1)) (> I72-m 8))))
(set-info :status sat)
(check-sat)
(push 1)
(assert (and (or (distinct I72-y (ite B10-F I10-y 0)) (>= I72-m (- I11-N 4))) (or (= I72-y (ite B10-F I10-y 0)) (>= I72-y (- (ite B10-F I10-y 0) 1))) (distinct I72-y (ite B10-F I10-y 0)) (= I72-y (- (ite B10-F I10-y 0) 1)) (> I72-m 8) (>= I72-m (- (+ I11-N 12) 4)) (or (= I72-y (ite B10-F I10-y 0)) (distinct I72-y (- (ite B10-F I10-y 0) 1)) (> I72-m 8))))
(set-info :status sat)
(check-sat)
(push 1)
(assert B112-F)
...
(pop 1)
(push 1)
(assert (and B71-F (or (and (>= I72-y 2022) (or (distinct I72-y 2022) (>= I72-m 10)) (or (distinct I72-y 2022) (distinct I72-m 10) (>= I72-d 1))) (>= I71-N 2025)) (or (> I72-y 2022) (and (= I72-y 2022) (> I72-m 10)) (and (= I72-y 2022) (= I72-m 10) (> I72-d 1)) (and (= I72-y 2022) (= I72-m 10) (= I72-d 1))) (or (>= I71-N 2025) (distinct I71-N 2024) (< I11-N 5) (> I11-N 12)) (< I71-N 2025) (= I71-N 2024)))
(set-info :status sat)
(check-sat)
(push 1)
(assert (and (>= I72-y 2022) (or (distinct I72-y 2022) (>= I72-m 10)) (or (distinct I72-y 2022) (distinct I72-m 10) (>= I72-d 1)) (or (and (<= I72-y 2022) (or (distinct I72-y 2022) (<= I72-m 10)) (or (distinct I72-y 2022) (distinct I72-m 10) (<= I72-d 1)) (or (distinct I72-y 2022) (distinct I72-m 10) (distinct I72-d 1))) (or (< I11-N 5) (> I11-N 12)))))
(set-info :status sat)
(check-sat)
(push 1)
(assert (and (>= I72-y 2022) (or (distinct I72-y 2022) (>= I72-m 10)) (or (distinct I72-y 2022) (distinct I72-m 10) (>= I72-d 1)) (or (> I72-y 2022) (and (= I72-y 2022) (> I72-m 10)) (and (= I72-y 2022) (= I72-m 10) (> I72-d 1)) (and (= I72-y 2022) (= I72-m 10) (= I72-d 1))) (< I11-N 5) (<= I11-N 12)))
(set-info :status sat)
(check-sat)
(push 1)
(assert B1-F)
...
(pop 1)
(push 1)
(assert (and (or B57-F B62-F B67-F) (= I57 0) (= I58 0) (or (= I67 0) (distinct I68 0))))
(set-info :status unsat)
(check-sat)
(pop 1)
(push 1)
(assert (and (or B57-F B62-F B67-F) (or (= I57 0) (distinct I58 0)) (or (= I67 0) (distinct I68 0))))
(set-info :status sat)
(check-sat)
(push 1)
(assert B99-F)
