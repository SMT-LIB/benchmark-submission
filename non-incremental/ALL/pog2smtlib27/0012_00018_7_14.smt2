...
(declare-const s230 |POW (Z x POW (Z x POW (Z x Z)))|)
(declare-const s239 |POW (Z x Z)|)
(declare-const s90 |Z|)
(declare-const s229 |POW (Z x POW (Z x POW (Z x Z)))|)
(declare-const s210 |Z|)
(declare-const s194 |Z|)
(declare-const s233 |POW (Z x Z)|)
(declare-const s138 |Z|)
(declare-const s227 |POW (Z x POW (Z x Z))|)
(declare-const s19 |POW Z|)
(declare-const s226 |POW (Z x POW (Z x Z))|)
...
(declare-const s221 |POW (Z x POW (Z x POW (Z x Z)))|)
...
(declare-const s75 |Z|)
(declare-const s240 |POW (Z x POW (Z x Z))|)
...
(declare-const s247$1 |POW (Z x POW (Z x Z))|)
...
(declare-const s228 |POW (Z x POW (Z x Z))|)
(declare-const s21 |POW Z|)
(declare-const s95 |Z|)
(declare-const s246 |Z|)
(declare-const s260$1 |Z|)
...
(declare-const s237 |POW (Z x Z)|)
(declare-const s247 |POW (Z x POW (Z x Z))|)
(declare-const s20 |POW Z|)
(declare-const s77 |Z|)
(declare-const s65 |Z|)
(declare-const s182 |Z|)
(declare-const s78 |Z|)
(declare-const s247$2 |POW (Z x POW (Z x Z))|)
(declare-const s92 |Z|)
...
(declare-const s69 |Z|)
(declare-const s54 |Z|)
(declare-const s232 |POW (Z x POW (Z x Z))|)
(declare-const s155 |Z|)
(declare-const s153 |Z|)
(declare-const s249$1 |POW (Z x Z)|)
...
(declare-const s238 |POW (Z x Z)|)
(declare-const s38 |POW ((Z x Z) x Z)|)
(declare-const s241 |POW (Z x POW (Z x Z))|)
(declare-const s242 |Z|)
(declare-const s28 |POW (BOOL x Z)|)
(declare-const s248 |POW (Z x Z)|)
...
(assert (!
  ...
  :named |Local_Hyp:0|))
(assert (!
  (< (|size Z| (|fun.eval Z POW (Z x Z)| s247$1 s254)) s199)
  :named |Local_Hyp:1|))
(assert (!
  (= (|fun.eval (Z x Z) Z| s45 (maplet (|size Z| (|fun.eval Z POW (Z x Z)| s247$1 s254)) 1)) (|min| (|set.intent Z| (lambda ((_c0 |Z|)) (or (= _c0 s199)(= _c0 (+ (|size Z| (|fun.eval Z POW (Z x Z)| s247$1 s254)) 1)))))))
  :named |Local_Hyp:2|))
(assert (!
  (|set.in Z| s260$1 s21)
  :named |Local_Hyp:3|))
(assert (!
  (|set.in Z| s260$1 (|interval| 1 s199))
  :named |Local_Hyp:4|))
(assert (!
  (|set.in POW (Z x POW (Z x Z))| s247 (|functions.total Z POW (Z x Z)| (|interval| 0 s182) (|seq Z| s20)))
  :named |Local_Hyp:5|))
(assert (!
  (|set.in Z| s260$1 (|interval| 1 (+ (|size Z| (|fun.eval Z POW (Z x Z)| s247 s254)) 1)))
  :named |Local_Hyp:6|))
(assert (!
  (|set.in POW (Z x POW (Z x Z))| s247$2 (|functions.total Z POW (Z x Z)| (|interval| 0 s182) (|seq Z| s20)))
  :named |Local_Hyp:7|))
(assert (!
  (|set.in Z| s254 s21)
  :named |Hypothesis:0|))
(assert (!
  (|set.in Z| s254 (|interval| 0 s182))
  :named |Hypothesis:1|))
(assert (!
  (|set.in Z| s259 s20)
  :named |Hypothesis:2|))
...
(assert (!
  (|set.in POW ((Z x Z) x Z)| s214 (|functions.total (Z x Z) Z| (|set.product Z Z| (|interval| 0 s182) (|interval| 0 s184)) s20))
  :named |Define:ctx:262|))
(assert (!
  (|set.in POW (Z x Z)| s215 (|functions.total Z Z| (|interval| 0 s182) s20))
  :named |Define:ctx:263|))
(assert (!
  (|set.in POW (Z x Z)| s216 (|functions.total Z Z| s20 s20))
  :named |Define:ctx:264|))
(assert (!
  (|set.in POW (Z x POW (Z x Z))| s247$1 (|functions.total Z POW (Z x Z)| (|interval| 0 s182) (|seq Z| s20)))
  :named |Define:imext:0|))
(assert (!
  (forall
  ((s250 |Z|))
  (=>
    (|set.in Z| s250 (|interval| 0 s182))
    (<= (|size Z| (|fun.eval Z POW (Z x Z)| s247$1 s250)) s199)))
  :named |Define:imext:1|))
(assert (!
  (|set.in Z| s219 s21)
  :named |Define:seext:2|))
(assert (!
  (|set.in POW (Z x Z)| s220 (|functions.total Z Z| (|interval| 0 s182) s21))
  :named |Define:seext:4|))
(assert (!
  (|set.in POW (Z x POW (Z x POW (Z x Z)))| s221 (|functions.total Z POW (Z x POW (Z x Z))| (|interval| 0 s182) (|functions.total Z POW (Z x Z)| (|interval| 0 s184) (|functions.total Z Z| (|interval| 0 s204) s21))))
...
(assert (!
  (|set.in POW (Z x POW (Z x Z))| s226 (|functions.total Z POW (Z x Z)| (|interval| 0 s182) (|functions.total Z Z| (|interval| 0 s184) s20)))
  :named |Define:seext:10|))
(assert (!
  (|set.in POW (Z x POW (Z x Z))| s227 (|functions.total Z POW (Z x Z)| (|interval| 0 s182) (|functions.total Z Z| (|interval| 0 s184) s20)))
  :named |Define:seext:11|))
(assert (!
  (|set.in POW (Z x POW (Z x Z))| s228 (|functions.total Z POW (Z x Z)| (|interval| 0 s182) (|functions.total Z Z| (|interval| 0 s184) s20)))
  :named |Define:seext:12|))
(assert (!
  (|set.in POW (Z x POW (Z x POW (Z x Z)))| s229 (|functions.total Z POW (Z x POW (Z x Z))| (|interval| 0 s182) (|functions.total Z POW (Z x Z)| (|interval| 0 s184) (|functions.total Z Z| (|interval| 0 s210) s21))))
  :named |Define:seext:13|))
(assert (!
  (|set.in POW (Z x POW (Z x POW (Z x Z)))| s230 (|functions.total Z POW (Z x POW (Z x Z))| (|interval| 0 s182) (|functions.total Z POW (Z x Z)| (|interval| 0 s184) (|functions.total Z Z| (|interval| 0 s210) s21))))
  :named |Define:seext:14|))
(assert (!
  (|set.in POW (Z x Z)| s231 (|functions.total Z Z| (|interval| 0 s182) s21))
  :named |Define:seext:15|))
(assert (!
  (|set.in POW (Z x POW (Z x Z))| s232 (|functions.total Z POW (Z x Z)| (|interval| 0 s182) (|functions.total Z Z| (|interval| 0 s206) s21)))
...
(assert (!
  (|set.in POW (Z x Z)| s237 (|functions.total Z Z| (|interval| 0 s182) s20))
  :named |Define:seext:21|))
(assert (!
  (|set.in POW (Z x Z)| s238 (|functions.total Z Z| (|interval| 0 s182) s20))
  :named |Define:seext:22|))
(assert (!
  (|set.in POW (Z x Z)| s239 (|functions.total Z Z| (|interval| 0 s182) s20))
  :named |Define:seext:23|))
(assert (!
  (|set.in POW (Z x POW (Z x Z))| s240 (|functions.total Z POW (Z x Z)| (|interval| 0 s182) (|functions.total Z Z| (|interval| 0 s208) s21)))
  :named |Define:seext:24|))
(assert (!
  (|set.in POW (Z x POW (Z x Z))| s241 (|functions.total Z POW (Z x Z)| (|interval| 0 s182) (|functions.total Z Z| (|interval| 0 s208) s21)))
...
(assert (!
  ...
  :named |Define:abs:0|))
(assert (!
  (|set.in POW (Z x Z)| s248 (|functions.total Z Z| (|interval| 0 s182) NATURAL))
  :named |Define:abs:1|))
(assert (!
  (= s247 s247$1)
  :named |Define:inv:0|))
(assert (!
  (|set.in POW (Z x Z)| s249$1 (|functions.total Z Z| (|interval| 0 s182) s20))
  :named |Define:inv:1|))
(assert (!
  (forall
  ((s250 |Z|))
  (=>
    (and
      (|set.in Z| s250 (|interval| 0 s182))
      (<= (|fun.eval Z Z| s248 s250) s194))
    (= (|fun.eval Z Z| s248 s250) (- s192 (|fun.eval Z Z| s249$1 s250)))))
  :named |Define:inv:2|))
(assert (!
  (forall
  ((s250 |Z|))
...
(assert (!
  (|set.in Z| s219 (|set.intent Z| (lambda ((_c0 |Z|)) (or (= _c0 1)(= _c0 2)))))
...
(assert (!
  (not
    (|set.in POW Z| (|set.inter Z| (|set.intent Z| (lambda ((_c0 |Z|)) (or (= _c0 s199)(= _c0 (+ (|size Z| (|fun.eval Z POW (Z x Z)| s247 s254)) 1))))) (|set.diff Z| INTEGER NATURAL)) (|finite sub-sets Z| INTEGER)))
  :named |Goal|))
(check-sat)
(exit)
